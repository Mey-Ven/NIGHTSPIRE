...
export function SplashScreen() {
    ...
    interval = setInterval(() => {
      setProgress((prev) => {
        if (prev >= 100) {
          ...
          // Set the final text when loading completes
          setMatrixText("WELCOME LEGENDE")
          setLoadingComplete(true)
          setTimeout(() => setIsComplete(true), 1500) // Longer delay to show the welcome message
          return 100
        }
        return prev + 1
      })
  ...
  return (
    ...
    >
      ...
      <div className="font-mono text-white mb-4 h-6">{`CONNECTING_TO_NIGHTSPARE_LEGACY: ${matrixText}`}</div>
